...
import 'package:app/capstone_project/api_provider.dart';
import 'package:app/capstone_project/webapp_payment.dart';
...
class _SecondRouteState extends State<SecondRoute> {
  ...
  //
  String webApplicationId = '664bee501a3e8df0963005f2';
  String androidApplicationId = '664bee501a3e8df0963005f3';
  String iosApplicationId = '664bee501a3e8df0963005f4';
  ...
  Future<String> getUserToken(BuildContext context) async {
    String restApplicationId = "664bee501a3e8df0963005f5";
    String pk = "2owklujDwddkUufx9AXYHiaVqcKMeRIiubsFXIVYvws=";
